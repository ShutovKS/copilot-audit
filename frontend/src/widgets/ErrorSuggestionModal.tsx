...
export const ErrorSuggestionModal = () => {
	...
	return (
		<div
			className="absolute inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-6 animate-in fade-in duration-300">
				...
				<div className="space-y-3">
					{isFreeModel && (
						...
						>
							...
							<div>
								<h4 className="text-xs font-bold text-white mb-1 group-hover:text-[#00b67a] transition-colors">Смените
									модель на Qwen 3 Coder</h4>
