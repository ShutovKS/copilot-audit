...
class TestGenerationResponse(BaseModel):
	...
	generated_code_path: str | None = Field(None, description="Path to the final Python code generated by the agent")
	test_plan_path: str | None = Field(None, description="Path to the step-by-step test plan created by Analyst")
